...
(3)	*repetition*: for real data analysis, it stands for the number of phenotypes need to be computed; for simulation data analysis, it stands for the number of repetitions need to be computed.
